...
#change the work director
os.chdir('C:/Users/13327/Desktop/schoolworks/classes/IBI/class_materials/practical7/')
dalys_data=pd.read_csv('dalys-rate-from-all-causes(1).csv')
print(dalys_data.head(5)) #test if it works
print(dalys_data.describe()) #test if it works
